...
Validated again after RE-01 on 2026-08-21. The real zero-argument ./run.sh resolved clean psxport 2b5ef7b5, extracted SLUS_008.93 from the configured disc, matched sha1 f90c9cd6..., built toystory2_seam with Clang, and exited 3 naming only the remaining RE-02/RE-03 substrate blockers. RE-01 is no longer presented as open. The production-injected --selftest still passed 3/3: default command sequence and exit 3, missing-tool refusal, and provisioning failure before configure/build. The prior CC=/bin/false negative still exits 1 naming the non-Clang compiler.

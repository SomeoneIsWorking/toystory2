// recomp_register.cpp — fills the framework↔generated-substrate seam (recomp_iface.h) from THIS game's
// recompiled symbols. This is the ONE file that names generated/ symbols; the framework reaches them
// only through psxport_recomp()->field.
//
// It therefore cannot compile until a substrate exists. `generated/` is produced by the recompiler,
// which needs this game's seed file AND its overlay load bases — RE-02 and RE-03 in docs/re-frontier.md,
// neither done, and RE-03 is a real open step here rather than a skip: this game has 22 code overlays.
// The build reflects that honestly rather than papering over it: cmake/toystory2_port.cmake configures
// the port target ONLY when generated/rec_sources.cmake exists, and this file belongs to that target
// alone. The seam-check target (which DOES build today) compiles game_config.cpp / game_hooks.cpp /
// main.cpp against the framework headers and deliberately excludes this file.
//

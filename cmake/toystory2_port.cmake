...
target_include_directories(
  toystory2_projection_boundary PRIVATE game game/core ${PSXPORT_DIR}/tests
)
...
target_include_directories(
  toystory2_cd_hle_boundary PRIVATE game game/core ${PSXPORT_DIR}/tests
)
target_link_libraries(toystory2_cd_hle_boundary PRIVATE psxport)
set_target_properties(
  toystory2_cd_hle_boundary
  PROPERTIES CXX_STANDARD 20 CXX_STANDARD_REQUIRED ON
             RUNTIME_OUTPUT_DIRECTORY ${CMAKE_SOURCE_DIR}/scratch/bin
...
# The title's finite-frame sequencing and createFrameDriver factory are hermetic: the boundary uses
# the shipping ordering function with an injected recorder, and constructs a real Game to prove the
# runtime supplies the driver the shared shell requires. No generated bytes or GPU are executed.
add_executable(
...
target_include_directories(
  toystory2_frame_driver_boundary PRIVATE game game/core ${PSXPORT_DIR}/tests
)
target_link_libraries(toystory2_frame_driver_boundary PRIVATE psxport)
set_target_properties(
  toystory2_frame_driver_boundary
  PROPERTIES CXX_STANDARD 20 CXX_STANDARD_REQUIRED ON
             RUNTIME_OUTPUT_DIRECTORY ${CMAKE_SOURCE_DIR}/scratch/bin
